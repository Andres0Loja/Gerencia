...
a persistence unit "SOAPPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "SOAP\pom.xml":
...
artifact ("SOAP.war") is already built. You can build
