 ...
 */
package ec.edu.ups.servicies;

import ec.edu.ups.SOAP.Alumno;
...
public class AlumnoFacadeREST extends AbstractFacade<Alumno> {
    ...
    @PersistenceContext(unitName = "SOAPPersistenceUnit")
    ...
    public void create(Alumno entity) {
        super.create(entity);
        this.em = Persistence.createEntityManagerFactory("SOAPPersistenceUnit").createEntityManager();
    }
