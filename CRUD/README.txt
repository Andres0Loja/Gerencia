...
a persistence unit "CRUDPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "CRUD\pom.xml":
...
artifact ("CRUD.war") is already built. You can build
