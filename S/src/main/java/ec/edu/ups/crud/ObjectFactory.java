 ...
 * generated in the ec.edu.ups.crud package. 
...
public class ObjectFactory {
    ...
    private final static QName _RegistrarResponse_QNAME = new QName("http://CRUD.ups.edu.ec/", "registrarResponse");
    private final static QName _Registrar_QNAME = new QName("http://CRUD.ups.edu.ec/", "registrar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ec.edu.ups.crud
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://CRUD.ups.edu.ec/", name = "registrarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://CRUD.ups.edu.ec/", name = "registrar")
